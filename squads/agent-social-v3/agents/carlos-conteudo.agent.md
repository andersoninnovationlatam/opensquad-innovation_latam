---
id: squads/agent-social-v3/agents/carlos-conteudo
...
- Injetar palavras genéricas de quantificação ("Milhares", "Vários") no início do Slide 1 que não constem no dado-âncora original.
