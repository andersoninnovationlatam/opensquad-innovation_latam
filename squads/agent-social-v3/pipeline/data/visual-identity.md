...
## Extensões obrigatórias — agent-social-v3
...
5. **Viewport exact (agent-social-v3):** Body width and height must be exactly **1080px × 1350px**
...
**Squad `agent-social-v3`:** seguir `layout-variations.md` + `real-imagery-and-safe-zones.md` — **1080×1350px**, **slide 1** hook à esquerda na banda; **slides 2–6** texto **à esquerda**; **padding lateral 100px**; **rodapé** `@innovationlatam` + `ARRASTE ->` em todos os slides.
