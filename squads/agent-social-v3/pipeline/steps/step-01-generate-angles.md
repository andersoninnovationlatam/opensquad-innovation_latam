...
outputFile: squads/agent-social-v3/output/angles.yaml
---

## Context Loading

Antes de executar, carregar:
- `squads/agent-social-v3/input/content.md` — notícia ou texto-base **e** `angulo_escolhido` no frontmatter YAML (obrigatório: `medo` | `oportunidade` | `educacional` | `contrario` | `inspiracional`)
- `squads/agent-social-v3/pipeline/data/domain-framework.md` — os 5 ângulos e critérios de seleção
- `squads/agent-social-v3/pipeline/data/tone-of-voice.md` — os 6 tons e vocabulário
- `squads/agent-social-v3/pipeline/data/anti-patterns.md` — o que evitar no copy
- `squads/agent-social-v3/agents/carlos-conteudo/tasks/generate-angles.md` — task file detalhado
