...
inputFile: squads/agent-social-v3/output/angles.yaml
outputFile: squads/agent-social-v3/output/carousel-draft.md
---

## Context Loading

Antes de executar, carregar:
- `squads/agent-social-v3/output/angles.yaml` — ângulo selecionado e hook preview
- `squads/agent-social-v3/input/content.md` — texto-base / notícia + `angulo_escolhido` no frontmatter (o ângulo já está espelhado em `angles.yaml`)
- `squads/agent-social-v3/pipeline/data/tone-of-voice.md` — regras de tom e vocabulário
- `squads/agent-social-v3/pipeline/data/anti-patterns.md` — o que nunca fazer
- `squads/agent-social-v3/pipeline/data/output-examples.md` — referência de qualidade
- `squads/agent-social-v3/pipeline/data/real-imagery-and-safe-zones.md` — **norma** para imagens temáticas, Visual cues, data-URI e safe zones (obrigatório)
- `squads/agent-social-v3/pipeline/data/layout-variations.md` — visual cues para Dária (estruturas v3, 1080×1350)
- `squads/agent-social-v3/agents/carlos-conteudo/tasks/create-slides.md` — task file
