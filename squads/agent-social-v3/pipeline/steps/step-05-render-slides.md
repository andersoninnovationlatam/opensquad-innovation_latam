...
outputFile: squads/agent-social-v3/output/slides/
---

## Context Loading

Antes de executar, carregar:
- `squads/agent-social-v3/output/slides/design-documentation.md` — confirmação de quais HTMLs foram gerados
- `squads/agent-social-v3/agents/daria-design/tasks/render-slides.md` — task file detalhado
- `squads/agent-social-v3/pipeline/data/real-imagery-and-safe-zones.md` — export **JPEG** único em `rendered/`
