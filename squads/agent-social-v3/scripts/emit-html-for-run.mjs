 ...
 * Uso (raiz do repo): node squads/agent-social-v3/scripts/emit-html-for-run.mjs <run-id>
 */
import fs from "fs";
...
const draftPath = path.join(REPO, "squads/agent-social-v3/output", runId, "v1/carousel-draft.md");
...
const outDir = path.join(REPO, "squads/agent-social-v3/output", runId, "slides/v1");
