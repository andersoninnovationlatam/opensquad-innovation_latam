...
5. **Nunca fabricar dados** — toda afirmação deve ser rastreável à notícia fornecida. Dados extras precisam de fonte.
6. **CTA alinhado ao funil** — awareness: salvar/compartilhar. Consideração: comentar/DM. Nunca CTA passivo.
...
5. **CTA passivo ou ausente**: posts sem instrução de ação geram menos engajamento e não sinalizam ao algoritmo.
...
3. **Atribuir a fonte da notícia no último slide**: credibilidade e proteção contra questionamentos de precisão.
...
- [ ] Último slide com CTA específico e acionável
