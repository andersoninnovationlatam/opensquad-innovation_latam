...
2. **Verificar o slide 1 antes de renderizar o lote** — um erro no sistema multiplicado por 10 slides é 10x retrabalho.
3. **Vocabulário técnico obrigatório** — câmera, luz e lente sempre do `guia_diretor_arte.md`. Nunca inventar termos fora da lista.
4. **Branding em todos os slides, sem exceção** — logo branco + @innovationlatam, canto inferior direito, margem 32-48px.
5. **Overlay obrigatório em slides com foto** — texto sobre imagem sem contraste viola WCAG AA e soa amador.
6. **1080×1350px em todos os slides** — dimensão fixa deste squad. Nunca usar 1080×1440 ou outras variações.
7. **HTML completamente self-contained** — apenas Google Fonts @import como recurso externo. Tudo mais inline.
